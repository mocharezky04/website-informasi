...
INSERT INTO articles
    (title, summary, content, image_url, author, published_date, category, tags, created_at, updated_at)
VALUES
    (
        'Mendeteksi Lateral Movement Menggunakan Active Directory Security Log Event ID 4624',
        'Panduan praktis deteksi intrusi menggunakan analisis Logon Type pada Windows Security event log untuk menghentikan pergerakan hacker di jaringan.',
        '### Pendahuluan
...
- Lakukan penarikan RAM dump dari host target untuk analisa volatile memory lebih lanjut.',
        ...
        'Zacky Ramadhan (SOC Analyst Lead)',
        '2026-05-15',
        'Incident Response',
        '["incident-response","windows-security","active-directory","threat-hunting"]',
        NOW(),
        NOW()
    ),
    (
        'Linux Server Hardening: Kebijakan SSH Terbaik untuk Menghentikan Serangan Brute Force',
        'Konfigurasi terpadu berkas sshd_config untuk memitigasi akses tidak sah dan implementasi multi-layer pertahanan cyber pada server Linux.',
...
Dengan memblokir port default, mematikan otentikasi password, dan menginstal auto-ban, Anda menghilangkan lebih dari 99% serangan berulang otomatis di internet.',
        ...
        'Amanda Putri (SecOps Engineer)',
        '2026-05-22',
        'System Hardening',
        '["system-hardening","linux","ssh-hardening","fail2ban"]',
        NOW(),
        NOW()
    ),
    (
        'Analisis Forensik Digital: Melacak Jejak Persistensi Malware Ransomware Melalui Registry Windows',
        'Eksplorasi forensik digital pada artifak Windows Registry untuk merekonstruksi jejak persistensi malware yang berupaya berjalan otomatis saat booting.',
        '### Pendahuluan
...
3. **Analisa Timestamp Amandemen:** Registry Windows menyimpan metadata tentang kapan kueri terakhir dimodifikasi, membantu penentuan rentang waktu insiden (timeline analysis).',
        ...
        'Ryan Setiadi (Digital Forensics Lead)',
        '2026-05-28',
        'Digital Forensics',
        '["digital-forensics","malware-analysis","windows-registry","incident-handling"]',
        NOW(),
        NOW()
    );
