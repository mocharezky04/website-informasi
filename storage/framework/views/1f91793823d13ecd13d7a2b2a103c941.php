...
<div class="space-y-5 max-w-full overflow-hidden">
    <div class="aspect-[16/9] md:max-h-[320px] w-full bg-neutral-950 border border-neutral-800 rounded-xl overflow-hidden relative">
        <div class="absolute top-3 left-3 z-10 bg-neutral-950/90 text-neutral-300 text-[9px] border border-neutral-800 px-3 py-1 rounded font-bold uppercase tracking-wider font-mono"><?php echo e($article->category); ?></div>
        <img
    ...
    <div class="space-y-2">
        <div class="flex flex-wrap items-center gap-3 text-neutral-400 text-xs font-mono">
            <span>Oleh: <?php echo e($article->author); ?></span>
            <span class="text-neutral-700">|</span>
            <span>Diterbitkan: <?php echo e($article->published_date?->format('Y-m-d')); ?></span>
        </div>
    </div>
    ...
    <div class="markdown-body space-y-4 text-neutral-300 font-serif leading-relaxed text-[13px] sm:text-sm break-words max-w-full overflow-hidden">
        <?php echo \App\Support\MarkdownRenderer::render($article->content); ?>

    </div>
    <div class="flex flex-wrap gap-2 pt-4 border-t border-neutral-800 mt-6">
        <?php $__currentLoopData = $article->tags ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <span class="text-[10px] font-mono bg-neutral-950 text-neutral-500 border border-neutral-800 rounded px-2.5 py-0.5">#<?php echo e($tag); ?></span>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
</div>
<?php /**PATH /home/vol15_2/infinityfree.com/if0_42129557/htdocs/resources/views/articles/_detail.blade.php ENDPATH**/ ?>